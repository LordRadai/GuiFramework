...
namespace GuiFramework
{
	...
	public:
		 ...
		 */
		void Connect(GUIObject* pOwner, const GUISignalDecl* pSignalDeclaration, GUIMsgReceiver* pReceiver, DLRF::DLMethodResolver<DLRF::DLMethodInvokeContext>* pResolver, dl_uint param_5 = 0, dl_uint param_6 = 0);
