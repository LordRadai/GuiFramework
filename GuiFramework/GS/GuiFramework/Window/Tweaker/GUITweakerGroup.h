...
namespace GuiFramework
{
	...
	public:
		...
		GUITweakerGroupItem* CreateSubGroup(TGUISharedString<dl_wchar> label, dl_uint flags = 0);
		...
		{
			TGUIProxyOnOffTweaker<T>* pTweaker = new TGUIProxyOnOffTweaker<T>(this, label, v, bitIndex, bitOffset);
