...
namespace GuiFramework
{
	...
	public:
		...
		typedef dl_uint(_fastcall* IsNode_t)(const GUIPopupMenuItem*);
		typedef void(_fastcall* OnRender_t)(const GUIPopupMenuItem*, GraphicsContext&);
		typedef void(_fastcall* OnRenderIcon_t)(const GUIPopupMenuItem*, GraphicsContext&);
		typedef dl_uint(_fastcall* OnLButtonDown_t)(const GUIPopupMenuItem*, const MouseEvent&, const Rect&);
