...
namespace GuiFramework
{
	...
	public:
		...
		virtual dl_uint OnOwnerSizeChanged(const TGUI_SIZE<int>& size) override;
		virtual dl_uint AutoAdd(GUIWindowBase* pWindow) override;
		virtual dl_uint AutoRemove(GUIWindowBase* pWindow) override;
